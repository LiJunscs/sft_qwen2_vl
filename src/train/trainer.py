            ...
            optimizer_grouped_parameters = [
                {
                    "params": [
                        ...
                        if (n in decay_parameters and n in self.args.projector_param_name and p.requires_grad)
                    ],
                ...
                },
                {
                    "params": [
                        p
                        for n, p in opt_model.named_parameters()
                        if (n not in decay_parameters and n in self.args.projector_param_name and p.requires_grad)
                    ],
                    "weight_decay": 0.0,
                    "lr": self.args.projector_lr,
                },
                {
                    "params": [
                        p
                        for n, p in opt_model.named_parameters()
                        if (n in decay_parameters and n in self.args.vm_param_name and p.requires_grad)
                    ],
                    "weight_decay": self.args.weight_decay,
                ...
                },
                {
                    "params": [
                        p
                        for n, p in opt_model.named_parameters()
                        if (n not in decay_parameters and n in self.args.vm_param_name and p.requires_grad)
                    ],
                    "weight_decay": 0.0,
                    "lr": self.args.vision_tower_lr,
                },
                {
                    "params": [
                        p
                        for n, p in opt_model.named_parameters()
                        if (n in decay_parameters and n in self.args.lm_param_name and p.requires_grad)
                    ],
                    "weight_decay": self.args.weight_decay,
                ...
                },
                {
                    "params": [
                        p
                        for n, p in opt_model.named_parameters()
                        if (n not in decay_parameters and n in self.args.lm_param_name and p.requires_grad)
                    ],
                    "weight_decay": 0.0,
                    "lr": self.args.language_model_lr,
                },
